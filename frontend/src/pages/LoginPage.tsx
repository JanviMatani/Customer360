          ...
          <div className="pt-2 border-t border-gray-100">
            ...
            {showHelper && (
              <div className="mt-2 p-2 bg-[#F8FAFC] border border-gray-200 rounded text-[11px] font-mono space-y-1 text-gray-600">
                <div><span className="font-semibold text-blue-700">RM:</span> rm1@firm.com</div>
                <div><span className="font-semibold text-emerald-700">Manager:</span> manager@firm.com</div>
                <div><span className="font-semibold text-red-700">Admin:</span> admin@firm.com</div>
                <div className="text-[10px] text-gray-400 border-t border-gray-200 pt-1 mt-1">Password: demo123</div>
              </div>
            )}
          </div>
        </div>
