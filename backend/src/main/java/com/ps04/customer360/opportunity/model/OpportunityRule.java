...
public class OpportunityRule {
    ...
    public OpportunityRule(String id, String product, List<RuleCondition> conditions, int minScore, boolean active) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public OpportunityRule build() {
            return new OpportunityRule(id, product, conditions, minScore, active);
        }
    }
